...
- Works mainly for expertise, tone, and style
- Role only steer the model to the subset of data through role,
...
- An example of this if we were doing more research into getting our application live:
    ...
    Our prompt library currently runs entirely in the browser with localStorage. 
    We're considering making it a production-ready tool that teams can use. 
    ...
    Use your experience to make opinionated recommendations. 
    Write as if you're presenting to a junior engineering team.
